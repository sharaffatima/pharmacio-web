...
/// [ocrResultId] is populated from the real API after OCR processing.
/// When null, the item is mock/placeholder data.
class CompareOfferItem {
  final int? ocrResultId; // null = mock data, int = real OCR result
  final String name;
  ...
  /// Returns placeholder items. Real items come from uploaded+processed files.
  /// ocrResultId is null for placeholders — only populated items trigger real API calls.
  static List<CompareOfferItem> sampleData() => [
    CompareOfferItem(
      name: 'Upload files to see real offers',
      supplier: '—',
      items: 0,
      date: '—',
    ),
