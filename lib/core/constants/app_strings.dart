class AppStrings {
  ...
  // ─── Purchase Proposals ───────────────────────────────────────────────────
  static String get purchaseProposals =>
      currentLanguage == 'ar' ? 'مقترحات الشراء' : 'Purchase Proposals';

  static String get adjustStock =>
      currentLanguage == 'ar' ? 'تعديل المخزون' : 'Adjust Stock';
  ...
  static String get markAsRead =>
      currentLanguage == 'ar' ? 'تحديد كمقروء' : 'Mark as Read';

  static String get unreadOnly =>
      currentLanguage == 'ar' ? 'غير المقروءة فقط' : 'Unread Only';
