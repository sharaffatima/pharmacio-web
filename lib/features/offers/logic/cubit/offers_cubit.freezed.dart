...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<OfferModel> offers)?  success,TResult Function( String error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case OffersInitial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<OfferModel> offers)  success,required TResult Function( String error)  error,}) {final _that = this;
switch (_that) {
case OffersInitial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<OfferModel> offers)?  success,TResult? Function( String error)?  error,}) {final _that = this;
switch (_that) {
case OffersInitial() when initial != null:
return initial();case OffersLoading() when loading != null:
return loading();case OffersSuccess() when success != null:
...
class OffersSuccess implements OffersState {
  const OffersSuccess(final  List<OfferModel> offers): _offers = offers;
