...
class AppColors {
  ...
  static const Color darkSlate = Color(0xff616161);
  static const Color dustyGrey = Color(0xFFA8A7A7);
  ...
  static const Color indigoNight = Color(0xff0E162A);
  static const Color jetBlack = Color(0xff020618);

  // Text Colors
  static const Color charcoalBlack = Color(0xFF1A1A1A);
  static const Color coolGrey = Color(0xFF707070);
  static const Color greyStone = Color(0xFF777777);
  static const Color lightSlate = Color(0xFF94A3B8);
  static const Color lightSlateDark = Color(0xFF8A8080);

  // Input Field Colors
  static const Color offWhiteBlue = Color(0xffFDFDFF);
  static const Color lightGreyText = Color(0xffC2C2C2);
  static const Color gainsboro = Color(0xffEDEDED);
  ...
  static Color coral = Color(0xFFEF4444).withValues(alpha: 0.2);
  ...
  static Color violet = Color(0xFF8B5CF6).withValues(alpha: 0.2);

  // Card and Background Colors
  static const Color offWhiteGrey = Color(0xFFF7F7F7);
  static const Color midnightBlue = Color(0xFF1A1F3A);
