class AppStrings {
  ...
  static String get warehouseNameLabel =>
      currentLanguage == 'ar' ? 'اسم المستودع' : 'Warehouse Name';

  static String get warehouseNameHint => currentLanguage == 'ar'
      ? 'مثال: المستودع الرئيسي'
      : 'e.g., Main Warehouse';

  static String get warehouseNameRequired => currentLanguage == 'ar'
      ? 'يرجى إدخال اسم المستودع قبل رفع الملف'
      : 'Please enter the warehouse name before uploading';

  static String get processingDocumentNotice => currentLanguage == 'ar'
      ? 'جاري معالجة المستند، يرجى الانتظار...'
  ...
  static String get selectAtLeast2 => currentLanguage == 'ar'
      ? 'اختر عرضاً واحداً على الأقل لاستخراج أفضل الأسعار'
      : 'Select at least 1 offer to extract best prices';
  ...
  // ─── Proposal Details: Download / Print / Suppliers ──
  ...
  static String supplierItemsCount(int count) => currentLanguage == 'ar'
      ? '$count عنصر'
      : '$count item${count == 1 ? '' : 's'}';

  static String get supplierSubtotalLabel =>
      currentLanguage == 'ar' ? 'إجمالي المورّد' : 'Supplier Subtotal';

  static String get unknownSupplier =>
      currentLanguage == 'ar' ? 'مورّد غير محدد' : 'Unknown Supplier';
  ...
  static String get featureUnavailableYet => currentLanguage == 'ar'
      ...
      : 'This feature is not available yet. Backend is preparing it.';
